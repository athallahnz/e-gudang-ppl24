...
class GoogleCalendarApi { 
    ...
    public function CreateCalendarEvent($access_token, $calendar_id, $event_data,  $all_day, $event_datetime, $event_timezone, $opts) { 
        ...
        $curlPost['attendees'] = $event_data['attendees']; 
        $curlPost['reminders'] = $event_data['reminders']; 
        $curlPost['sendNotifications'] = $event_data['sendNotifications']; 
        $curlPost['conferenceDataVersion'] = $event_data['conferenceDataVersion']; 
        // $curlPost['attendees'] = array(
        //     array('email' => 'keuangan@stikes-yrsds.ac.id'),
        //     array('email' => 'alief@stikes-yrsds.ac.id'));

        $curlPost['sendNotifications'] = array('sendNotifications' => true); 
        // -----
