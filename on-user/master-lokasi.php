          ...
          <div class="card">
            <div class="card-body">
              ...
              <button type="button" class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#disablebackdrop">
                <i class="bi bi-plus me-1"></i> Lokasi Baru
              </button>
                ...
                <div class="modal-dialog modal-lg">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <form class="row g-3 needs-validation" method="POST" action="proses-save-lokasi" enctype="multipart/form-data" id="devel-generate-content-form" novalidate>
                        <?php
                        ...
                        <div class="col-md-12 mb-2">
                          ...
                          <input type="text" name="nama" class="form-control" placeholder="Nama Lokasi" required>
                          <div class="invalid-tooltip">Wajib Diisi</div>
                        </div>

                        <div class="col-md-12 mb-2">
                          <label for="lokasi" class="form-label">Alamat <span class="text-danger">*</span></label>
              ...
              </div><!-- End Modal Tambah Lokasi Baru -->
              ...
              <table id="example" class="table table-striped dt-responsive example" style="width:100%;">
                ...
                <tbody>
                  <?php 
                    $no = 0;
                    $result_dokumen = mysqli_query($connect,"SELECT id, nama, alamat FROM lokasi_aset ORDER BY id ASC");
                  ...
                  <tr>
                    ...
                    <td><?php echo htmlspecialchars($row_dokumen->alamat ); ?></td>
                    <td><?php echo htmlspecialchars($row_dokumen->deskripsi ); ?></td>
                    <td>
                      <a href='menu-edit-lokasi?id=<?php echo urlencode(encrypt_decrypt2('encrypt', $row_dokumen->id)); ?>' class='btn btn-primary btn-sm' title='Edit Lokasi'>
                        <i class='bi bi-pencil-square'></i>
                      </a>
                      <a href='menu-detail-lokasi?id=<?php echo urlencode(encrypt_decrypt2('encrypt', $row_dokumen->id)); ?>' class='btn btn-primary btn-sm' title='Detail Lokasi'>
                        <i class='bi bi-eye'></i>
                      </a>
                      <a href='proses-delete-lokasi?id=<?php echo urlencode(encrypt_decrypt2('encrypt', $row_dokumen->id)); ?>' class='btn btn-danger btn-sm alert_delete' title='Hapus Lokasi'>
