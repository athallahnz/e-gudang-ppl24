...
$id_lokasi = encrypt_decrypt2('decrypt', $_GET['id']);
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="col-md-12 mb-2">
                ...
                <input type="text" class="form-control" name="alamat" value="<?php echo htmlspecialchars($row_dokumen->alamat); ?>" disabled>
              </div>
              ...
              <div class="col-md-12 mb-2">
                <label for="edited" class="form-label">Telokasihir diubah pada </label>
              ...
              <div class="col-md-12 mb-2">
                <label for="edited_by" class="form-label">Telokasihir diubah oleh </label>
