...
// Pastikan ID lokasi tersedia di URL dan valid
if (!isset($_GET['id']) || empty($_GET['id'])) {
    header('Location: 404');
    exit();
}

// Menggunakan fungsi decrypt untuk mendapatkan ID lokasi
$id_rak = encrypt_decrypt2('decrypt', $_GET['id']);
...
$stmt = $connect->prepare("SELECT * FROM lokasi_aset WHERE id = ?");
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="master-lokasi">Master Lokasi</a></li>
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              ...
              <form action="proses-edit-lokasi" method="POST" enctype="multipart/form-data" class="row g-3 needs-validation" novalidate>
                <!-- Hidden field for ID -->
                ...
                <div class="col-md-12">
                  ...
                  <input type="text" class="form-control" name="nama" value="<?php echo htmlspecialchars($row_dokumen->nama); ?>" required>
                ...
                <div class="col-md-12">
                  ...
                  <input type="text" class="form-control" name="alamat" value="<?php echo htmlspecialchars($row_dokumen->alamat); ?>" required>
                  <div class="invalid-feedback">
                    Alamat wajib diisi.
                  </div>
                </div>
