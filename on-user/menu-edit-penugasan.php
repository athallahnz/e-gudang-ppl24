        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              ...
              <form action="proses-edit-penugasan" method="POST" enctype="multipart/form-data" class="row g-3 needs-validation" novalidate>
                <!-- Hidden field for ID -->
                <input type="hidden" name="id" value="<?php echo encrypt_decrypt2('encrypt', $row_dokumen->id); ?>" />

                <div class="col-md-12">
                  <label for="nama" class="form-label">Nama Penugasan <span class="text-danger">*</span></label>
