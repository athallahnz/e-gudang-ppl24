...
$stmt = $connect->prepare("SELECT * FROM satuan_aset WHERE id = ?");
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="master-satuan">Master Satuan</a></li>
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              ...
              <form action="proses-edit-satuan" method="POST" enctype="multipart/form-data" class="row g-3 needs-validation" novalidate>
                <!-- Hidden field for ID -->
