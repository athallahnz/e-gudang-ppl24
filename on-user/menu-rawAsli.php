            ...
            <div class="card-body">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="col-md-12 mb-2">
                        ...
                        <select name="material" class="form-select" id="material" required>
                          <?php
                            $result_jenis = mysqli_query($connect,"SELECT * FROM material_aset WHERE id IN (2) ORDER BY nama asc");
                            if($result_jenis) {
                      ...
                      <div class="col-md-12 mb-2">
                        ...
                        <select name="klasifikasi" id="klasifikasi" class="form-select" required onchange="getTipeByKlasifikasi(this.value)">
                          ...
                          <?php
                            $result_jenis = mysqli_query($connect,"SELECT * FROM klasifikasi_aset WHERE id_material NOT IN (1,3) ORDER BY nama asc");
                            if($result_jenis) {
                              if($result_jenis->num_rows > 0) {
                                while($row_jenis = $result_jenis->fetch_object()) {
                                  echo "<option value='$row_jenis->id'>".htmlspecialchars_decode($row_jenis->nama)."</option>";
                      ...
                      <div class="col-md-12 mb-2" id="tipe-wrapper">
                      ...
                      <div class="col-md-12 mb-2" id="panjang-input" style="display: none;">
                        <label for="panjang" class="form-label">Ukuran Panjang <span class="text-danger">*</span></label>
                        <div class="input-group">
                      ...
                      <div class="col-md-12 mb-2" id="lebar-input" style="display: none;">
                        <label for="lebar" class="form-label">Ukuran Lebar <span class="text-danger">*</span></label>
                        <div class="input-group">
              ...
              <table id="example" class="table table-striped dt-responsive" style="width:100%;">
                ...
                <tbody>
                  <?php 
                    $no = 0;
                    $result_dokumen = mysqli_query($connect,"SELECT id_aset, a.nama, tgl_masuk, nomor_aset, b.nama as material, qrcode, qty, c.nama as satuan, d.nama as klasifikasi, e.nama as vendor, f.nama as tipe, ketebalan, diameter, a.panjang as panjangaset, a.lebar as lebaraset, f.panjang as panjangtipe, f.lebar as lebartipe, a.id_klasifikasi
                    FROM aset a 
                    ...
                    INNER JOIN tipe_aset f on a.id_tipe=f.id
                    WHERE a.id_material IN (2) order by id_aset desc");
                  ...
                  <tr>
                    ...
                    <td><?php echo $row_dokumen->tipe;

                    if ($row_dokumen->id_klasifikasi==141) {
                      echo "<br><span class='badge bg-primary'>".$row_dokumen->ketebalan."mm x".$row_dokumen->panjangtipe."mm x ".$row_dokumen->lebartipe."mm</span>";
                    } else if ($row_dokumen->id_klasifikasi==142){
                      echo "<br><span class='badge bg-primary'>".$row_dokumen->diameter."mm x".$row_dokumen->panjangaset."mm</span>";
                    } else if ($row_dokumen->id_klasifikasi==143){
                      echo "<br><span class='badge bg-primary'>".$row_dokumen->ketebalan."mm x".$row_dokumen->panjangaset."mm x".$row_dokumen->lebaraset."mm</span>";
                    }
                    // else {
