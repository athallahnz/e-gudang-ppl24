...
if (!$token || $token !== $_SESSION['token']) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $stmt = $connect->prepare("INSERT INTO  material_aset (nama, deskripsi, created_by, last_created) VALUES (?, ?, ?, now())");
        ...
        if ($simpan) {
            ...
            $status_log = "User dengan ID ($id_user) menambahkan material baru dengan ID ($last_id)";
